...
Defined in: [src/lib/spring.ts:30](https://github.com/cdellacqua/spring-store.js/blob/main/src/lib/spring.ts#L30)
...
Defined in: [src/lib/spring.ts:31](https://github.com/cdellacqua/spring-store.js/blob/main/src/lib/spring.ts#L31)
